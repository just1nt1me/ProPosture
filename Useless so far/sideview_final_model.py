...
with mp.solutions.pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        try:
            ...
            #### Visualize angle
            left_neck_text_position = (image.shape[1] - 220, 30)
            ...
            #### Visualize angle
            right_neck_text_position = (image.shape[1] - 220, 60)
            ...
            #### Visualize angle
            left_knee_text_position = (image.shape[1] - 220, 210)
            ...
            #### Visualize angle
            right_knee_text_position = (image.shape[1] - 220, 240)
